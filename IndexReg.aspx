<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="IndexReg.aspx.cs" Inherits="IndexReg" %>
                                                ...
                                                <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                               ...
                                                               <div class="input-group mobile_new_input" style="border:1px solid black">
...
<%--                                                        <div class="form-group">
                                                          ...
                                                          <%--  <input runat="server" class="form-control track" type="text" onkeypress="return AllowAlphabet(event)" name="name" id="Text1" placeholder="தங்களது முழுப்பெயர்" />--%>
                                                                   <textarea id="txtadress" name="txtadress" class="form-control track" runat="server" rows="1" cols="50" maxlength="25"></textarea>  
                                                        <asp:RequiredFieldValidator SetFocusOnError="true" ID="RequiredFieldValidator10" runat="server" ControlToValidate="txtadress" ErrorMessage="விலாசம் பதிவிடவும் " ValidationGroup="One" ForeColor="Red" Font-Names="Impact"></asp:RequiredFieldValidator>
                                                          ...
                                                          <%--  <input runat="server" class="form-control track" type="text" onkeypress="return AllowAlphabet(event)" name="name" id="Text1" placeholder="தங்களது முழுப்பெயர்" />--%>
                                                                   <textarea id="txtadress2" name="txtadress2" class="form-control track" runat="server" rows="1" cols="50" maxlength="25"></textarea>  
                                                       <%-- <asp:RequiredFieldValidator SetFocusOnError="true" ID="RequiredFieldValidator12" runat="server" ControlToValidate="txtadress" ErrorMessage="விலாசம் பதிவிடவும் " ValidationGroup="One" ForeColor="Red" Font-Names="Impact"></asp:RequiredFieldValidator>--%>
                                                               </div> 
                                                                    <div class="form-group">
                                                                    <label class='label-control'><b> விலாசம் 3 (Address3) <span class="asterisk"></span></b></label>    
                                                          <%--  <input runat="server" class="form-control track" type="text" onkeypress="return AllowAlphabet(event)" name="name" id="Text1" placeholder="தங்களது முழுப்பெயர்" />--%>
                                                                   <textarea id="txtadress3" name="txtadress3" class="form-control track" runat="server" rows="1" cols="50" maxlength="25"></textarea>  
                                                       <%-- <asp:RequiredFieldValidator SetFocusOnError="true" ID="RequiredFieldValidator13" runat="server" ControlToValidate="txtadress" ErrorMessage="விலாசம் பதிவிடவும் " ValidationGroup="One" ForeColor="Red" Font-Names="Impact"></asp:RequiredFieldValidator>--%>
                                                               </div> 
                                                 ...
                                                 <div class="row">
                                                     ...
                                                     <div class="col-md-6">
                                                          <div class="form-group">
                                                              ...
                                                              <input runat="server" class="form-control track" type="text" Visible="false" name="txtdesination" id="txtdesination" placeholder="உறுப்பினரின் பதவி" maxlength="20" />
