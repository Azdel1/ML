...
public partial class PrintCard : System.Web.UI.Page
{
    ...
    public void TextToImage(DataTable dtprintdata)
    {
        ...
        try
        {
            ...
            PointF Location_Address1 = new PointF(10f, 07.5f);
            PointF Location_Address2 = new PointF(10f, 56f);
            PointF Location_Address3 = new PointF(10f, 106f);
            PointF Location_dateofbirth = new PointF(10f, 173f);
            PointF Location_contact = new PointF(10f, 230f);
            PointF Location_blood = new PointF(10f, 284f);
            ...
            {
                using (System.Drawing.Font tamilFont = new System.Drawing.Font("Franklin Gothic Demi", 20, FontStyle.Bold))
                using (System.Drawing.Font arialFont = new System.Drawing.Font("Franklin Gothic Demi", 22))
                {
                    if (Regex.IsMatch(Convert.ToString(Name), "^[a-zA-Z0-9 ]*$"))
                    {
                        graphics.DrawString(Name, arialFont, Brushes.Black, Location_Name);
                        graphics.DrawString(designation, arialFont, Brushes.Green, Location_designation);
                    }
                    else
                    {
                        graphics.DrawString(Name, tamilFont, Brushes.Black, Location_Name);
                    }
                    graphics.DrawString(membershipid, arialFont, Brushes.Black, Location_membershipid);
                    graphics.DrawString(designation, arialFont, Brushes.Green, Location_designation);
            ...
            using (Graphics graphics = Graphics.FromImage(bitmap2))
            {
                ...
                using (System.Drawing.Font arialFont = new System.Drawing.Font("Franklin Gothic Demi", 22))
                {
                    if (Regex.IsMatch(Convert.ToString(Address1), "^[a-zA-Z0-9 ]*$"))
                    {
                        graphics.DrawString(Address1, arialFont, Brushes.Black, Location_Address1);
                    }
                    else
                    {
                        graphics.DrawString(Address1, tamilFont, Brushes.Black, Location_Address1);
                        
                    }
                    if (Regex.IsMatch(Convert.ToString(Address2), "^[a-zA-Z0-9 ]*$"))
                    {
                        graphics.DrawString(Address2, arialFont, Brushes.Black, Location_Address2);
                    }
                    else
                    {
                        graphics.DrawString(Address2, tamilFont, Brushes.Black, Location_Address2);

                    }
                    if (Regex.IsMatch(Convert.ToString(Address3), "^[a-zA-Z0-9 ]*$"))
                    {
                        graphics.DrawString(Address3, arialFont, Brushes.Black, Location_Address3);
                    }
                    else
                    {
                        graphics.DrawString(Address3, tamilFont, Brushes.Black, Location_Address3);

                    }
                    graphics.DrawString(dateofbirth, arialFont, Brushes.Black, Location_dateofbirth);
                    graphics.DrawString(contact, arialFont, Brushes.Black, Location_contact);
                    graphics.DrawString(blood, arialFont, Brushes.Black, Location_blood);
                }
            }
